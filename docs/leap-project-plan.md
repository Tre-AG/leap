...
- **Prior AI usage:** Simple multi-select (never used AI tools / tried ChatGPT a few times / use AI occasionally / use AI regularly)
...
- **Claude Code:** Building, debugging, iterating on code
- **Git:** Commit often with clear messages for easy rollback
...
14. Build the V1 — frontend flow, API integration, results page
15. Alpha test — send to 5-10 close friends/family, gather feedback
